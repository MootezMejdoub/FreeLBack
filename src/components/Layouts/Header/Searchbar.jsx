...
const Searchbar = () => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="w-full sm:w-9/12 h-8 px-1 sm:px-4 py-0 flex justify-between items-center shadow-md bg-white rounded-sm overflow-hidden">
